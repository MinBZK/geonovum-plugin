...
Scant SKILL.md en reference.md in de skills-directory.
Classificeert URLs per type (github_repo, geonovum_doc, forum, pdok).
...
URL_PATTERNS = {
    "github_repo": re.compile(r"https://github\.com/Geonovum/[A-Za-z0-9._-]+"),
    "geonovum_doc": re.compile(r"https://docs\.geostandaarden\.nl/[^\s\)\]\"'>]+"),
    "forum": re.compile(r"https://www\.forumstandaardisatie\.nl/[^\s\)\]\"'>]+"),
    "pdok": re.compile(r"https://(?:www\.)?pdok\.nl/[^\s\)\]\"'>]+"),
    "geonovum_site": re.compile(r"https://(?:www\.)?geonovum\.nl/[^\s\)\]\"'>]+"),
}

# URLs die geen echte bronnen zijn (voorbeelden, namespaces, lokale adressen)
EXCLUDE_PATTERNS = [
    ...
    re.compile(r"https?://schemas\.opengis\.net/"),
