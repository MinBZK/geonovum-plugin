...
**Deze plugin is geen officieel product van [Geonovum](https://www.geonovum.nl).** De inhoud is gebaseerd op publiek beschikbare standaarden en documentatie die door Geonovum worden beheerd, maar is onafhankelijk samengesteld door developer.overheid.nl.

## De skills in deze plugin zijn niet de officiële standaarden

De beschrijvingen in de skills zijn samenvattingen en interpretaties, **niet** de officiële standaarden zelf — tenzij dat nadrukkelijk is aangegeven. De teksten zijn deels gegenereerd en samengesteld met behulp van AI (Large Language Models) en kunnen onvolledigheden of onjuistheden bevatten.
...
- **[Geonovum](https://www.geonovum.nl)** — de beheerorganisatie van de geo-standaarden in deze plugin
- De **gepubliceerde specificaties** op [docs.geostandaarden.nl](https://docs.geostandaarden.nl) en in de [Geonovum](https://github.com/Geonovum) GitHub-organisatie
